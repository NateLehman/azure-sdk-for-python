...
try:
    ...
    from .event_route_collection_py3 import EventRouteCollection
    from .digital_twins_model_data_py3 import DigitalTwinsModelData
    from .paged_digital_twins_model_data_collection_py3 import PagedDigitalTwinsModelDataCollection
    from .relationship_collection_py3 import RelationshipCollection
    from .incoming_relationship_py3 import IncomingRelationship
    from .incoming_relationship_collection_py3 import IncomingRelationshipCollection
    ...
    from .bulk_import_job_collection_py3 import BulkImportJobCollection
    ...
    from .event_route_collection import EventRouteCollection
    from .digital_twins_model_data import DigitalTwinsModelData
    from .paged_digital_twins_model_data_collection import PagedDigitalTwinsModelDataCollection
    from .relationship_collection import RelationshipCollection
    from .incoming_relationship import IncomingRelationship
    from .incoming_relationship_collection import IncomingRelationshipCollection
    from .query_specification import QuerySpecification
    from .query_result import QueryResult
    from .inner_error import InnerError
    from .error import Error
    from .bulk_import_job import BulkImportJob
    from .bulk_import_job_collection import BulkImportJobCollection
