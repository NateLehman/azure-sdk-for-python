...
class DigitalTwinModelsOperations(object):
    ...
    def add(
        ...
        * ModelAlreadyExists - The model provided already exists.
        ...
        :rtype: list[~azure.digitaltwins.core.models.DigitalTwinsModelData] or
    ...
    def list(
        ...
        * ModelNotFound - The model was not found.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: PagedDigitalTwinsModelDataCollection or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.digitaltwins.core.models.PagedDigitalTwinsModelDataCollection
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PagedDigitalTwinsModelDataCollection', response)
    ...
    def get_by_id(
        ...
        * ModelNotFound - The model was not found.
        ...
        :rtype: ~azure.digitaltwins.core.models.DigitalTwinsModelData or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.digitaltwins.core.models.ErrorResponseException>`
        """
