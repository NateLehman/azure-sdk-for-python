...
class ImportJobsOperations(object):
    ...
    def list(
        ...
        * 200 OK.
        ...
        :type import_jobs_list_options:
         ~azure.digitaltwins.core.models.ImportJobsListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: BulkImportJobCollection or ClientRawResponse if raw=true
        :rtype: ~azure.digitaltwins.core.models.BulkImportJobCollection or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BulkImportJobCollection', response)
    ...
    def add(
        ...
        * ValidationFailed - The bulk job request is not valid.
        ...
        :type import_job: ~azure.digitaltwins.core.models.BulkImportJob
        :param import_jobs_add_options: Additional parameters for the
         operation
        :type import_jobs_add_options:
         ~azure.digitaltwins.core.models.ImportJobsAddOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.digitaltwins.core.models.BulkImportJob or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.digitaltwins.core.models.ErrorResponseException>`
        """
    ...
    def get_by_id(
        ...
        * BulkJobNotFound - The bulk job was not found.
        ...
        :type import_jobs_get_by_id_options:
         ~azure.digitaltwins.core.models.ImportJobsGetByIdOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def delete(
        ...
        * ValidationFailed - The bulk job request is not valid.
        ...
        :type import_jobs_delete_options:
         ~azure.digitaltwins.core.models.ImportJobsDeleteOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def cancel(
        ...
        * ValidationFailed - The bulk job request is not valid.
        ...
        :type import_jobs_cancel_options:
         ~azure.digitaltwins.core.models.ImportJobsCancelOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
